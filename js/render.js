...
const Render = {
  ...
  updateGridInventory(context = 'profile') {
    // Carousel overlay has its own rendering — only update the profile grid.
    ...
    // Last-used aside slot (profile page)
  ...
  /**
   * Called by popup "Benutzen" button.
   * Sequence: lock btn → animate slot (flash) → 380ms delay → apply effect → close popup
   */
